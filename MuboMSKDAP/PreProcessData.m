...
%... At this stage, muscle data are not to be considered.
NMuscles = Jnt.NMuscles;
Jnt.NMuscles = 0;
...
%... After the definition of the initial conditions, the muscles can now be
% considered
Flag.InitData     = 1;
Jnt.NMuscles = NMuscles;
%... Initialize data for Muscle Joints
